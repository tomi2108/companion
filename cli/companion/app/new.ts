...
export default {
  ...
  handler: async () => {
    ...
    if (type === "app") {
      ...
      function getMovedFilesFromConnections(c: Connection | null) {
        ...
        if (c === DaoConnections.mongo) return [
          // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/companion/-/issues/49]: add tests for bau connection to template
    ...
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/companion/-/issues/59]: clone only deploy repo created
    ...
    if (type === "fcd") {
      // TODO [https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/companion/-/issues/73]: expose in 3scale
    }
