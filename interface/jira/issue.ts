...
export class Issue {
  ...
  async edit() {
    return await this.jira.updateIssue(this.id, {
      // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/45]: fields
    });
  }
  ...
  view() {
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/60]: implement
  }
  ...
  async link(issue: Issue, linkType: any) {
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/52]: test
  ...
  async unlink(issue: Issue) {
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/65]: implement
    console.log("issue:", issue);
  }

  async logWork(work: string) {
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/61]: test, maybe make 'work' a :number in hours ?
  ...
  async addToCurrentSprint() {
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/43]: test
    const board_id = Config.get().jira.board_id;
    if (!board_id) throw new Error("No board id set");
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/47]: fix circular dependency
  ...
  async assign(user: string) {
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/40]: test
    return await this.jira.updateAssignee(this.key, user);
  }

  async estimate(estimacion: string) {
    // TODO[https://gitlab-ee.agil.movistar.com.ar/movar_app/tools/rishi/-/issues/50]: test
    const board_id = Config.get().jira.board_id;
