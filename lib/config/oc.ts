...
export class OpenShiftConfig implements IntegrationConfig, Schema {
  ...
  prod() {
    this.server_name = process.env.MARO_PROD_OC_SERVER_NAME ?? "";
    this.server_cuyo = process.env.MARO_PROD_OC_SERVER_CUYO ?? "";
    this.auth_server_cuyo = process.env.MARO_PROD_OC_AUTH_SERVER_CUYO ?? "";
  }
