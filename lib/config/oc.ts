...
export class OpenShiftConfig implements IntegrationConfig, Schema {
  ...
  server_name = process.env.COMPANION_OC_SERVER_NAME ?? "";
  auth_server_cuyo = process.env.COMPANION_OC_AUTH_SERVER_CUYO ?? "";
  auth_server_barracas = process.env.COMPANION_OC_AUTH_SERVER_BARRACAS ?? "";
  server_cuyo = process.env.COMPANION_OC_SERVER_CUYO ?? "";
  server_barracas = process.env.COMPANION_OC_SERVER_BARRACAS ?? "";
  ...
  prod() {
    this.server_name = process.env.COMPANION_PROD_OC_SERVER_NAME ?? "";
    this.server_cuyo = process.env.COMPANION_PROD_OC_SERVER_CUYO ?? "";
    this.auth_server_cuyo = process.env.COMPANION_PROD_OC_AUTH_SERVER_CUYO ?? "";
  }
